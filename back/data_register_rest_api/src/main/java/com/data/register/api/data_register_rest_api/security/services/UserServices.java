...
public class UserServices {
    ...
    public ServerResponse<String> userLogin(User user) {
        if (userRepository.existsById(user.getUsername())) {
            if (bCryptPasswordEncoder.matches(user.getPassword(), userRepository.findById(user.getUsername()).get().getPassword())) {
